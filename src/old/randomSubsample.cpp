...
virtual shared_ptr<Population> randomSubsample(size_t size) const = 0;


shared_ptr<Population> Population_Organisms::randomSubsample(size_t size) const
{
    ...
    shared_ptr<Population_Organisms> subsample(new Population_Organisms()); // TODO: fix
